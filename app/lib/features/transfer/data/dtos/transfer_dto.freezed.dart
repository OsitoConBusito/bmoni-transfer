...
mixin _$TransferDto {
 ...
 String get transferId; String get status; String get quoteId; MoneyDto get sourceAmount; MoneyDto get destAmount; MoneyDto get fee; String get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,transferId,status,quoteId,sourceAmount,destAmount,fee,createdAt);

@override
String toString() {
  return 'TransferDto(transferId: $transferId, status: $status, quoteId: $quoteId, sourceAmount: $sourceAmount, destAmount: $destAmount, fee: $fee, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String transferId, String status, String quoteId, MoneyDto sourceAmount, MoneyDto destAmount, MoneyDto fee, String createdAt
});


$MoneyDtoCopyWith<$Res> get sourceAmount;$MoneyDtoCopyWith<$Res> get destAmount;$MoneyDtoCopyWith<$Res> get fee;
...
/// Create a copy of TransferDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? transferId = null,Object? status = null,Object? quoteId = null,Object? sourceAmount = null,Object? destAmount = null,Object? fee = null,Object? createdAt = null,}) {
...
as MoneyDto,createdAt: null == createdAt ? _self.createdAt : createdAt // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
/// Create a copy of TransferDto
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String transferId,  String status,  String quoteId,  MoneyDto sourceAmount,  MoneyDto destAmount,  MoneyDto fee,  String createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TransferDto() when $default != null:
return $default(_that.transferId,_that.status,_that.quoteId,_that.sourceAmount,_that.destAmount,_that.fee,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String transferId,  String status,  String quoteId,  MoneyDto sourceAmount,  MoneyDto destAmount,  MoneyDto fee,  String createdAt)  $default,) {final _that = this;
switch (_that) {
case _TransferDto():
return $default(_that.transferId,_that.status,_that.quoteId,_that.sourceAmount,_that.destAmount,_that.fee,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String transferId,  String status,  String quoteId,  MoneyDto sourceAmount,  MoneyDto destAmount,  MoneyDto fee,  String createdAt)?  $default,) {final _that = this;
switch (_that) {
case _TransferDto() when $default != null:
return $default(_that.transferId,_that.status,_that.quoteId,_that.sourceAmount,_that.destAmount,_that.fee,_that.createdAt);case _:
  return null;
...
class _TransferDto implements TransferDto {
  const _TransferDto({required this.transferId, required this.status, required this.quoteId, required this.sourceAmount, required this.destAmount, required this.fee, required this.createdAt});
...
@override $MoneyDtoCopyWith<$Res> get sourceAmount;@override $MoneyDtoCopyWith<$Res> get destAmount;@override $MoneyDtoCopyWith<$Res> get fee;
...
/// Create a copy of TransferDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? transferId = null,Object? status = null,Object? quoteId = null,Object? sourceAmount = null,Object? destAmount = null,Object? fee = null,Object? createdAt = null,}) {
