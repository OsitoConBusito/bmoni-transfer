...
Sin secretos en el cliente. `dio` con **certificate pinning** en prod (se salta en localhost). La
validación client-side es UX, no frontera: el BE es la autoridad. Build release ofuscado.
